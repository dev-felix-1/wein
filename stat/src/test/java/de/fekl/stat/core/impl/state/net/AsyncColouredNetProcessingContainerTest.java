...
//	@Test
	...
	public void testSplitAndMerge() {
		...
		AsyncColouredNetProcessingContainer<SimpleNode, SimpleToken> processingContainer = new AsyncColouredNetProcessingContainer<>(
				spongeNet, simpleTokenFactory);
...
//		System.err.println(ITokenStore.print(processingContainer.getCurrentState()));
	...
	public void testContainerReset() {
		...
		processingContainer = new AsyncColouredNetProcessingContainer<>(spongeNet, simpleTokenFactory);
	...
	private static class ValueHolderProcessingContainer
			extends AsyncColouredNetProcessingContainer<ValueModifierNode, ValueHolderToken> {
	...
	public void testProcessingHistory() {
		...
		var processingContainer = new AsyncColouredNetProcessingContainer<>(spongeNet, simpleTokenFactory);
