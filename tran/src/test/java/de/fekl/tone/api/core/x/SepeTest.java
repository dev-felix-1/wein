		...
		//@formatter:off
			new SpongeNetBuilder<SimpleNode>()
				.setGraph(new DirectedGraphBuilder<SimpleNode>()
					...
					.addNode(new SimpleNodeFactoryParams<SimpleNode>(NID_A))
					.addNode(new SimpleNodeFactoryParams<SimpleNode>(NID_B))
					.addNode(new SimpleNodeFactoryParams<SimpleNode>(NID_B2))
					.addNode(new SimpleNodeFactoryParams<SimpleNode>(NID_C))
					.addNode(new SimpleNodeFactoryParams<SimpleNode>(NID_D))
					.addEdge(NID_A, NID_B)
